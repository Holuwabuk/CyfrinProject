...
contract FundMeTest is Test {
    ...
    modifier funded() {
        //if you must do different funding,instead of repeating them over and over in your test function,you can have a modifier where the tests are run/simulated,and modifier added to test
        vm.prank(USER);
        fundMe.fund{value: SEND_VALUE}();
        _;
    }
